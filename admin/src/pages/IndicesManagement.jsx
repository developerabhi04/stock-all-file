...
const IndicesManagement = () => {
  ...
  const buildPayload = () => ({
    ...
    apiSymbol: formData.apiSymbol?.trim() || "",
    ...
    <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-6 gap-4">
              ...
              {categories.map((cat) => (
                <button
                  key={cat?._id || cat?.id}
                  onClick={() =>
                    filterByCategorySlug(cat?.slug || cat?.name || "")
                  }
                  className={`px-4 py-2 rounded-lg text-sm font-medium transition ${
                    filters?.category === (cat?.slug || cat?.name)
              ...
              <button
                onClick={() => {
                  setSearchTerm("");
                  dispatch(
                    setFilters({ category: "", featured: "", search: "" }),
                  );
                }}
      ...
      {indices.length === 0 ? (
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-16 text-center">
          ...
          <p className="text-gray-500 mb-6">
            {searchTerm
              ...
              : "Start by adding your first index"}
          </p>
          <button
            onClick={() => handleOpenModal()}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {indices.map((index) => {
            const categoryLabel =
              normalizeCategoryLabel(index) || getCategoryType(index);
              ...
              >
                <div className="flex items-start justify-between mb-4">
                  ...
                  >
                    <Star
                      size={18}
                      className={index?.isFeatured ? "fill-current" : ""}
                    />
                  </button>
                </div>
                ...
                <div
                  className={`mb-3 flex items-center space-x-2 rounded-lg px-3 py-2 border ${
          ...
          <div className="bg-white rounded-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleChange("previousClose", e.target.value)
                    }
                    className="w-full border border-gray-300 rounded-xl px-4 py-3 focus:ring-2 focus:ring-green-500 focus:border-transparent transition"
              ...
              <div>
                ...
                <input
                  type="text"
                  value={formData.apiSymbol}
                  onChange={(e) => handleChange("apiSymbol", e.target.value)}
                  className="w-full border border-gray-300 rounded-xl px-4 py-3 focus:ring-2 focus:ring-green-500 focus:border-transparent transition"
                  placeholder="e.g., ^NSEI or BTC-USD"
                />
                <p className="text-xs text-gray-500 mt-2">
                  Leave blank to keep updating this index manually. Filled
                  automatically by the daily market sync when set.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  ...
                  />
                  <p className="text-xs text-gray-500 mt-2">
                    Users can invest any amount above this minimum, based on
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleChange("defaultDailyRate", e.target.value)
                    }
                    className="w-full border border-gray-300 rounded-xl px-4 py-3 focus:ring-2 focus:ring-green-500 focus:border-transparent transition"
                    placeholder="e.g., 1 or 2"
                  />
                  <p className="text-xs text-gray-500 mt-2">
                    Shows fixed daily return in the app and can be used as
                    default return.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleChange("lockPeriodDays", e.target.value)
                    }
                    className="w-full border border-gray-300 rounded-xl px-4 py-3 focus:ring-2 focus:ring-green-500 focus:border-transparent transition"
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl w-full max-w-md p-6">
            ...
            <p className="text-gray-600 text-center mb-6">
              This action cannot be undone. The index will be permanently
