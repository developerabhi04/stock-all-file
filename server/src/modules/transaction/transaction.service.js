...
export const getAllTransactionsAdminService = async ({
    ...
    status,
    category,
    startDate, // 'YYYY-MM-DD' string coming from <input type="date"> on the frontend
    ...
    // Date range filter on createdAt — this was completely missing before,
    // which is why picking dates on the admin UI had zero effect on results.
    if (startDate || endDate) {
        ...
        // Guard against an empty {} object being attached if both dates were invalid
