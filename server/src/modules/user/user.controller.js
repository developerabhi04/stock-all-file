...
export const updateFcmToken = asyncHandler(async (req, res) => {
  ...
  res
    .status(200)
    .json(new ApiResponse(200, data, "FCM token saved successfully"));
});
...
export const getBankAccounts = asyncHandler(async (req, res) => {
  ...
  res
    .status(200)
    .json(new ApiResponse(200, data, "Bank accounts fetched successfully"));
});
...
export const addBankAccount = asyncHandler(async (req, res) => {
  ...
  res
    .status(201)
    .json(new ApiResponse(201, data, "Bank account added successfully"));
});
...
export const updateBankAccount = asyncHandler(async (req, res) => {
  ...
  res
    .status(200)
    .json(new ApiResponse(200, data, "Bank account updated successfully"));
});
...
export const deleteBankAccount = asyncHandler(async (req, res) => {
  ...
  res
    .status(200)
    .json(new ApiResponse(200, data, "Bank account deleted successfully"));
});
...
export const setPrimaryBankAccount = asyncHandler(async (req, res) => {
  ...
  res
    .status(200)
    .json(
      new ApiResponse(200, data, "Primary bank account updated successfully"),
    );
});
