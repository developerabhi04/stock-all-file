...
export const toggleUserGenuine = asyncHandler(async (req, res) => {
  const data = await toggleUserGenuineService({
    userId: req.params.userId,
    adminId: req.admin.adminId,
  });
  ...
  res
    ...
    .json(
      new ApiResponse(
        ...
        data,
        data.isGenuine
          ? "User marked as genuine"
          : "User removed from genuine users",
      ),
    );
});
...
export const getAdminActivity = asyncHandler(async (req, res) => {
  ...
  res
    .status(200)
    .json(new ApiResponse(200, data, "Admin activity fetched successfully"));
});
  ...
  res
    ...
    .json(
      new ApiResponse(
        200,
        data,
        "Complete dashboard stats fetched successfully",
      ),
    );
});
...
export const getWithdrawalStats = asyncHandler(async (req, res) => {
  ...
  res
    .status(200)
    .json(
      new ApiResponse(200, data, "Withdrawal statistics fetched successfully"),
    );
});
...
export const getUserStats = asyncHandler(async (req, res) => {
  ...
  res
    .status(200)
    .json(new ApiResponse(200, data, "User statistics fetched successfully"));
});
...
export const getMarketDashboardStats = asyncHandler(async (req, res) => {
  ...
  res
    .status(200)
    .json(
      new ApiResponse(200, data, "Market dashboard stats fetched successfully"),
    );
});
...
export const getAllIndicesAdmin = asyncHandler(async (req, res) => {
  ...
  res
    .status(200)
    .json(new ApiResponse(200, data, "Indices fetched successfully"));
});
...
export const createIndex = asyncHandler(async (req, res) => {
  ...
  res
    .status(201)
    .json(new ApiResponse(201, data, "Index created successfully"));
});
...
export const updateIndex = asyncHandler(async (req, res) => {
  ...
  res
    .status(200)
    .json(new ApiResponse(200, data, "Index updated successfully"));
});
...
export const getAllStocksAdmin = asyncHandler(async (req, res) => {
  ...
  res
    .status(200)
    .json(new ApiResponse(200, data, "Stocks fetched successfully"));
});
...
export const createStock = asyncHandler(async (req, res) => {
  ...
  res
    .status(201)
    .json(new ApiResponse(201, data, "Stock created successfully"));
});
...
export const updateStock = asyncHandler(async (req, res) => {
  ...
  res
    .status(200)
    .json(new ApiResponse(200, data, "Stock updated successfully"));
});
...
export const generateSampleChartData = asyncHandler(async (req, res) => {
  ...
  res
    .status(200)
    .json(
      new ApiResponse(200, data, "Sample chart data generated successfully"),
    );
});
